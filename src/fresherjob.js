...
function Fresher() {
 ...
 <div className="fresher4">
      ...
      <p className="fresher9">PYTHON,SQL</p>
 ...
 <p className="fresher9">Adaptable</p>
      ...
      <div className="fresher4">
        ...
        <h4 className="fresher10"> WHATSAPP CLONE USING HTML ,CSS</h4>
      ...
      <p className="fresher8">
       ...
       <p className="fresher8">
         <span className="fresher7"> .</span> A Tinker project using HTML and CSS typically involves creating a small, self-contained web project to 
         practice and experiment with front-end development skills.
       </p>

       <h4 className="fresher10"> REALTIME CHESSGAME USING HTML CSS $ JAVASCRIPT </h4>
       
       <p className="fresher8">
         <span className="fresher7"> .</span>A chess game created with HTML, CSS, and JavaScript uses HTML to define the chessboard and piece 
layout, with each square and piece represented by elements like CSS styles the board and pieces, ensuring 
proper colours, sizes, and positioning for a visually appealing design.
       </p>
       <p className="fresher8">
         <span className="fresher7"> .</span> JavaScript implements the game’s logic, handling piece movement, and enforcing rules  of chess game 
       </p>
      </div>   
